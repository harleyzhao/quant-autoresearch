...
P0 (technical validation). Done on day 1: kernel, three species, 16 tests, viewer, export, smoke test,
CI. Not yet: strand-based junctions, procedural bark/leaf materials, wind, LOD/impostors, USD.
